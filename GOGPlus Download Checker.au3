...
Func ImitationConsoleGUI($start)
	...
	GUICtrlSetTip($Checkbox_zip, "Compressed files (ZIP, 7Z, BZ2, GZ, PK4 only)!")
...
Func AddFileToList()
	...
	If $fext = ".exe" Or $fext = ".zip" Or $fext = ".7z" Or $fext = ".rar" Or $fext = ".sh" Or $fext = ".bz2" Or $fext = ".gz" Or $fext = ".pk4" Or $fext = ".pdf" Then
	...
	Else
		MsgBox(262192, "File Error", "Only BZ2, EXE, GZ, PDF, PK4, RAR, SH, ZIP, 7Z are currently supported!" & @LF _
